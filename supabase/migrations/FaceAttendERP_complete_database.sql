...
CREATE OR REPLACE FUNCTION "public"."delete_user_by_admin"("target_user_id" "uuid") RETURNS "void"
    ...
    AS $$
BEGIN
  -- CHECK: Only admins can perform this action
  IF NOT EXISTS (
  ...
  -- 3. Delete from auth.users (This requires SECURITY DEFINER)
...
ALTER TABLE "public"."class_codes" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "email" "text",
    CONSTRAINT "profiles_photo_status_check" CHECK (("photo_status" = ANY (ARRAY['pending'::"text", 'verified'::"text", 'rejected'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."timetable" (
    ...
    CONSTRAINT "timetable_day_of_week_check" CHECK (("day_of_week" = ANY (ARRAY['Monday'::"text", 'Tuesday'::"text", 'Wednesday'::"text", 'Thursday'::"text", 'Friday'::"text", 'Saturday'::"text", 'Sunday'::"text"])))
);
...
CREATE INDEX "profiles_face_embedding_idx" ON "public"."profiles" USING "ivfflat" ("face_embedding" "public"."vector_cosine_ops");



CREATE UNIQUE INDEX "subjects_subject_code_active_unique" ON "public"."subjects" USING "btree" ("subject_code") WHERE ("is_deleted" = false);
...
ALTER TABLE ONLY "public"."class_codes"
    ADD CONSTRAINT "class_codes_teacher_id_fkey" FOREIGN KEY ("teacher_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."class_codes"
    ADD CONSTRAINT "class_codes_timetable_id_fkey" FOREIGN KEY ("timetable_id") REFERENCES "public"."timetable"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."timetable"
    ADD CONSTRAINT "timetable_class_id_fkey" FOREIGN KEY ("class_id") REFERENCES "public"."classes"("id") ON DELETE SET NULL;
...
CREATE POLICY "Admins can delete attendance" ON "public"."attendance" FOR DELETE USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can delete class codes" ON "public"."class_codes" FOR DELETE USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Admins can delete issues" ON "public"."issues" FOR DELETE USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Admins can delete timetable" ON "public"."timetable" FOR DELETE USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can insert any issue" ON "public"."issues" FOR INSERT WITH CHECK ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Admins can insert attendance" ON "public"."attendance" FOR INSERT WITH CHECK ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Admins can insert timetable" ON "public"."timetable" FOR INSERT WITH CHECK ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can read all attendance" ON "public"."attendance" FOR SELECT USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can read all codes" ON "public"."class_codes" FOR SELECT USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can read all issues" ON "public"."issues" FOR SELECT USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));



CREATE POLICY "Admins can read all profiles" ON "public"."profiles" FOR SELECT USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Admins can update any issue" ON "public"."issues" FOR UPDATE USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Admins can update attendance" ON "public"."attendance" FOR UPDATE USING ("public"."has_role"("auth"."uid"(), 'admin'::"public"."app_role"));
...
CREATE POLICY "Anyone authenticated can read timetable" ON "public"."timetable" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can read teacher profiles" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "profiles"."user_id") AND ("user_roles"."role" = 'teacher'::"public"."app_role")))));
...
CREATE POLICY "Students can insert own attendance" ON "public"."attendance" FOR INSERT WITH CHECK (("auth"."uid"() = "student_id"));



CREATE POLICY "Students can read active codes" ON "public"."class_codes" FOR SELECT USING ((("is_active" = true) AND ("expires_at" > "now"())));



CREATE POLICY "Students can read own attendance" ON "public"."attendance" FOR SELECT USING (("auth"."uid"() = "student_id"));



CREATE POLICY "Students can update own attendance" ON "public"."attendance" FOR UPDATE USING (("auth"."uid"() = "student_id")) WITH CHECK (("auth"."uid"() = "student_id"));



CREATE POLICY "Teachers can insert attendance" ON "public"."attendance" FOR INSERT WITH CHECK ("public"."has_role"("auth"."uid"(), 'teacher'::"public"."app_role"));



CREATE POLICY "Teachers can insert codes" ON "public"."class_codes" FOR INSERT WITH CHECK ((("auth"."uid"() = "teacher_id") AND "public"."has_role"("auth"."uid"(), 'teacher'::"public"."app_role")));



CREATE POLICY "Teachers can read all roles" ON "public"."user_roles" FOR SELECT TO "authenticated" USING ("public"."is_teacher"());



CREATE POLICY "Teachers can read attendance" ON "public"."attendance" FOR SELECT USING ("public"."has_role"("auth"."uid"(), 'teacher'::"public"."app_role"));



CREATE POLICY "Teachers can read own class codes" ON "public"."class_codes" FOR SELECT TO "authenticated" USING (("teacher_id" = "auth"."uid"()));



CREATE POLICY "Teachers can read own codes" ON "public"."class_codes" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "teacher_id"));



CREATE POLICY "Teachers can read student profiles" ON "public"."profiles" FOR SELECT USING ("public"."has_role"("auth"."uid"(), 'teacher'::"public"."app_role"));



CREATE POLICY "Teachers can update attendance" ON "public"."attendance" FOR UPDATE USING ("public"."has_role"("auth"."uid"(), 'teacher'::"public"."app_role"));



CREATE POLICY "Teachers can update own codes" ON "public"."class_codes" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "teacher_id")) WITH CHECK (("auth"."uid"() = "teacher_id"));



CREATE POLICY "Teachers can update their own timetable entries" ON "public"."timetable" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "teacher_id")) WITH CHECK (("auth"."uid"() = "teacher_id"));
...
CREATE POLICY "Users can read own issues" ON "public"."issues" FOR SELECT USING (("auth"."uid"() = "user_id"));
